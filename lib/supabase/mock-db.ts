        ...
        plans: [
          {
            ...
            price: '$0',
            period: 'forever',
            description: 'Ideal for discovering faculty in any field and inspecting verification sources.',
            features: [
              '25 Global Verified Professor Searches / mo',
              'Access to all 190+ Countries & Disciplines',
              'Publication Metadata & Source Inspection',
              'Basic Email Personalization Preview',
            ],
            cta: 'Start Free',
            highlighted: false,
          },
          {
            ...
            price: '$19',
            period: 'per month',
            description: 'For active MS and PhD applicants targeting 20-50 faculty worldwide.',
            features: [
              'Unlimited Global Professor Searches',
              '75 AI Discipline-Aware Grounded Emails / mo',
