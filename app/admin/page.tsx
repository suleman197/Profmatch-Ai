...
export default function AdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'settings' | 'globalData' | 'paymentMethods' | 'orders' | 'content' | 'flags' | 'users' | 'audit'>('settings');
      ...
      {activeTab === 'users' && (
        <div className="glass-panel rounded-2xl border border-slate-800 overflow-hidden">
          <div className="p-6 border-b border-slate-800">
            <h2 className="text-base font-bold text-white">Registered Users & Staff</h2>
            <p className="text-xs text-slate-400">Manage permission tiers and access suspensions.</p>
          </div>
